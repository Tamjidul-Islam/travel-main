...
public class ForgotPassword extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == search)  {
            try {
                String query  = "select * from acnt where username = '"+tfusername.getText()+"' ";
                Conn c = new Conn();
            ...
            try {
                String query  = "select * from acnt where answer = '"+tfanswer.getText()+"' AND username = '"+tfusername.getText()+"' ";
                Conn c = new Conn();
