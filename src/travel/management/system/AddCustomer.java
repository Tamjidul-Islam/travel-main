...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer (String username) {
        ...
        comboid = new JComboBox (new String[]{"NID", "Passport", "TIN Card", "VGD Card"} );
       ...
       try{
           Conn c = new Conn();
           ResultSet rs = c.s.executeQuery("select * from acnt where username = '"+username+"' ");
           while(rs.next() ){
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == add){
             ...
             //+ "VALUES ('" + username + "', '" + id + "', '" + number + "', '" + name + "', '"
